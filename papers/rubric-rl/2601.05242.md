...
```mermaid
flowchart LR
  R[多 reward rollout] --> N1[每个 reward 独立 group normalize]
  N1 --> C[组合各维信号]
  C --> N2[batch-wise advantage normalize]
  N2 --> U[GRPO/PPO-style policy update]
```

原文的 GRPO 对照、数值流程和 reward 曲线见 [arXiv HTML](https://arxiv.org/html/2601.05242) Figure 1。
